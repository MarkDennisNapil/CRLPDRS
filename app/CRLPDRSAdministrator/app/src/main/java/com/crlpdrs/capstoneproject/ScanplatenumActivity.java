...
public class ScanplatenumActivity extends  AppCompatActivity  { 
	...
	private Button btnsearchplatenum;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		btnsearchplatenum = (Button) findViewById(R.id.btnsearchplatenum);
		...
		linear1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				webview1.loadUrl("https://crlpdrscapstoneproject.000webhostapp.com/verifystatus.php?platenum=".concat(""));
				webview2.loadUrl("https://crlpdrscapstoneproject.000webhostapp.com/platenumsearch.php?platenum=".concat(""));
			}
		});
		
		btnsearchplatenum.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
