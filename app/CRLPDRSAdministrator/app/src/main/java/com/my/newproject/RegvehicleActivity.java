...
public class RegvehicleActivity extends  Activity { 
	
	public final int REQ_CD_FP = 101;
	
	private ScrollView vscroll1;
	private LinearLayout linear1;
	private WebView wvregvehicle;
	
	private Intent fp = new Intent(Intent.ACTION_GET_CONTENT);
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.regvehicle);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		wvregvehicle = (WebView) findViewById(R.id.wvregvehicle);
		wvregvehicle.getSettings().setJavaScriptEnabled(true);
		wvregvehicle.getSettings().setSupportZoom(true);
		fp.setType("image/*");
		fp.putExtra(Intent.EXTRA_ALLOW_MULTIPLE, true);
		
		wvregvehicle.setWebViewClient(new WebViewClient() {
			@Override
	...
	private void initializeLogic() {
		wvregvehicle.setWebChromeClient(new WebChromeClient() {
			// For 3.0+ Devices
		...
		wvregvehicle.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
		wvregvehicle.loadUrl("https://crlpdrscapstoneproject.000webhostapp.com/registervehicle.php");
	}
