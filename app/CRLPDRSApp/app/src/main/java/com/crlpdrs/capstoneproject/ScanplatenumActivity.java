...
public class ScanplatenumActivity extends  AppCompatActivity  { 
	...
	private EditText etdetectedplatenum;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		etdetectedplatenum = (EditText) findViewById(R.id.etdetectedplatenum);
		...
		linear1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				webview2.loadUrl("https://crlpdrscapstoneproject.000webhostapp.com/verifystatus.php?platenum=".concat(etdetectedplatenum.getText().toString()));
				webview1.loadUrl("https://crlpdrscapstoneproject.000webhostapp.com/platenumsearch.php?platenum=".concat(etdetectedplatenum.getText().toString()));
			}
		});
		...
		btngetplatenum.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				send.putExtra("platenum", etdetectedplatenum.getText().toString());
				startActivity(send);
			}
		});
